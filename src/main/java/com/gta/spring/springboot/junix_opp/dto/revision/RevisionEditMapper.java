...
public class RevisionEditMapper implements Mapper<RevisionEditDTO, Revision> {
    ...
    private void copy(RevisionEditDTO object, Revision revision){
        ...
        revision.setDrawing(drawingService.findEntityById(object.getDrawingId()));
        ...
        revision.setInproductionDateManual(object.getInproductionDateManual());
        ...
        revision.setIsProcced(object.getIsProcced());
